...
<div class="atbd_tab_inner" id="profile">
    <form action="#" id="user_profile_form" method="post">
        <div class="directorist_user-profile">
            <div class="directorist_user-profile__left">
                
                <div class="directorist_card directorist_mb-30">
                    <div class="directorist_card__body">
                        <div class="directorist_profile-img-wrap">
                ...
                <div class="directorist_card">
                    <div class="directorist_card__header">
                        <h4 class="directorist_card__title">Change Password</h4>
                    </div>
                    <div class="directorist_card__body">
                        <form action="#">
                            <div class="directorist_change-pass-form">
                                <div class="form-group">
                                    <label>Old Password</label>
                                    <input type="password" class="form-control" name="directorist_old-pass" placeholder="Old Password">
                                </div>
                                <div class="form-group">
                                    <label>New Password</label>
                                    <input type="password" class="form-control" name="directorist_new-pass" placeholder="New Password">
                                    <span class="directorist_input-text">Must be at least 6 characters</span>
                                </div>
                                <div class="form-group">
                                    <button class="directorist-btn directorist-btn-dark directorist-btn-md">Save Changes</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="directorist_user-profile__right">
